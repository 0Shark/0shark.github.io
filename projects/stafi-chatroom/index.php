...
<div class="container">		
	...
	<?php } else { ?>
		<br>
		<br>
		<div style="background-color: #abd0f0; width: 300px; text-align: center; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
  border: 15px solid #327ab7;
  padding: 20px;
  margin: 20px;">
		<strong><h3>Welcome to Stafi!</h3></strong>	
		<div style="margin:50px 0px 0px 0px;">
			<a class="btn btn-default read-more" style="background:#3399ff;color:white" href="http://stafi.gq/login.php">Log in</a>
		</div>
		</div>		
	<?php } ?>
	<br>
